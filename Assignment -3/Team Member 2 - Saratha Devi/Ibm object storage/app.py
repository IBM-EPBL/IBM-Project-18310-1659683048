...
COS_API_KEY_ID="qGeHDj1nxIYL3h9jBDuf6TKcDnZHVwDYceTyu8ph6lrZ"
COS_INSTANCE_CRN="crn:v1:bluemix:public:iam-identity::a/a93482195b3e4ee9854fe72aa9a368f2::serviceid:ServiceId-5acd3d77-330a-4f9f-99e9-6b9ac033ab3c"
...
@app.route('/')
def index():
    files = get_bucket_contents('flask12345')
