...
COS_API_KEY_ID="sbBKAFN-DK1S0-4qg1fQcsPmAwY3QRmiDeKiKoihTfTQ"
COS_INSTANCE_CRN="crn:v1:bluemix:public:iam-identity::a/2f8dcb52ca344e458642326c943c21cf::serviceid:ServiceId-c7f2688e-b207-4b7c-adf3-0f78c4718e18"
...
@app.route('/')
def index():
    files = get_bucket_contents('flask12')
