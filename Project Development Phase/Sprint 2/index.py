...
import ibm_db
conn = ibm_db.connect('DATABASE=bludb;HOSTNAME=3883e7e4-18f5-4afe-be8c-fa31c41761d2.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31498;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=wqr23763;PWD=TJbYc0eUz7EZBqcv','','')

app = Flask(__name__)
app.secret_key="Don't Share"
myconn=ibm_db.connect('DATABASE=bludb;HOSTNAME=3883e7e4-18f5-4afe-be8c-fa31c41761d2.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31498;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=wqr23763;PWD=dyDwgsrX1kt4wgJn', '', ''
	)
@app.route("/signup")
def signup():
